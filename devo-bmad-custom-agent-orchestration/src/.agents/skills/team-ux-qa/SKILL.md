...
| Role | Agent | Skills |
|------|-------|--------|
| UX Designer | `bmad-agent-bmm-ux-designer` | Design, implementation (can write code), full dev skill access |
| QA | `bmad-agent-bmm-qa` | playwright-cli, visual + functional UI validation |
