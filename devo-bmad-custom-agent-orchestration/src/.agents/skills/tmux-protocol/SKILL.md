...
**This rule applies to EVERY user message while a team is active.** Active team = `active_team.panes` populated in `_bmad/_memory/master-orchestrator-sidecar/session-state.md`.
