...
| QA | `bmad-agent-bmm-qa` | playwright-cli, vulnerability path verification, regression testing |
| Dev | `bmad-agent-bmm-dev` | Security remediation, patch implementation |
