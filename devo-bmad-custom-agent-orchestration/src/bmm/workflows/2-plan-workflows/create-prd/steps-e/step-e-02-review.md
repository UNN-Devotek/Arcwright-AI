...
- IF AR: Execute `{project-root}/_bmad/core/tasks/review-adversarial-general.xml` — pass current editPlan as content to review; display findings with recommendations; then redisplay this menu
