...
Assess the PRD as a cohesive, compelling document — evaluating document flow, dual audience effectiveness (humans and LLMs), BMAD PRD principles compliance, and overall quality rating. This step runs autonomously — no user input needed.
