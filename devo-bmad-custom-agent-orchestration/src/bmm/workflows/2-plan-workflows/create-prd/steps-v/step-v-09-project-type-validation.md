...
Validate project-type specific requirements are properly documented — different project types (api_backend, web_app, mobile_app, etc.) have different required and excluded sections. This step runs autonomously — no user input needed.
