...
- Load: `{project-root}/_bmad/bmm/workflows/1-analysis/research/market-steps/step-06-research-completion.md`
...
After user selects 'C', load `{project-root}/_bmad/bmm/workflows/1-analysis/research/market-steps/step-06-research-completion.md` to produce the comprehensive market research document.
