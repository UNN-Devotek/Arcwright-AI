...
Instruct the user or orchestrator (master-orchestrator) to spawn the Analyst, Tech Writer/Architect, and PM agents in parallel to deeply analyze the brainstorming topic.
...
Teammate 1 (Business/Market Focus): run /arcwright-agent-awm-analyst to analyze the market viability, competitive landscape, and business value of the topic.
Teammate 2 (User/Product Focus): run /arcwright-agent-awm-pm to analyze the user personas, pain points, and core product experience of the topic.
Teammate 3 (Technical Focus): run /arcwright-agent-awm-architect to analyze the technical feasibility, architectural constraints, and implementation risks of the topic.
