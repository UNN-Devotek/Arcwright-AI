...
description: Generate or update module-help.csv for any Arcwright module with proper structure
web_bundle: false
...
mwm,phase-1,Daily Check In,DCI,10,_arcwright/mwm/workflows/daily-checkin/workflow.md,mwm_daily_checkin,false,wellness-companion,Check In Mode,"Start your day with wellness check-in",mwm_output,"summary",
mwm,phase-2,Wellness Journal,WJ,20,_arcwright/mwm/workflows/wellness-journal/workflow.md,mwm_journal,false,wellness-companion,Journal Mode,"Reflect and track your wellness journey",mwm_output,"entry",
```

### Standalone Module (like arcwright-custom):
```csv
module,phase,name,code,sequence,workflow-file,command,required,agent,options,description,output-location,outputs,
arcwright-custom,anytime,Quiz Master,QM,,"arcwright_quiz",false,,Trivia,"Interactive trivia quiz with gameshow atmosphere",arcwright_output,"results",
arcwright-custom,anytime,Wassup,WS,,"arcwright_wassup",false,,Status,"Check uncommitted changes and suggest commits",arcwright_output,"summary",
arcwright-custom,anytime,Write Commit,WC,,"arcwright_write_commit",false,commit-poet,Write,"Craft a commit message from your changes",arcwright_output,"message",
```
