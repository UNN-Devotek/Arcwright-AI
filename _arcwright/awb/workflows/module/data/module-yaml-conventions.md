...
`module.yaml` is the configuration file for a Arcwright module. It:
...
|-------------|------------------|---------|
| Core/Primary | `true` | AWM (agile software delivery) |
...
### AWM (Arcwright) — Complex Configuration

```yaml
code: awm
name: "AWM: Arcwright Agile-AI Driven-Development"
header: "Arcwright™: Breakthrough Method of Agile-Ai Driven-Dev"
...
```yaml
code: bmgd
name: "BMGD: Arcwright Game Development"
header: "Arcwright Game Development Module"
...
1. Run `arcwright install` in a test project
