...
**Purpose:** Defines what a Arcwright module is, its structure, and the three types of modules.

---

## What is a Arcwright Module?

A **Arcwright module** is a self-contained package of functionality that extends the Arcwright framework. Modules provide:
...
Extends an existing Arcwright module with additional functionality.
...
**Example:** An extension to AWM that adds specialized security review workflows
...
```yaml
# Base module: src/modules/awm/module.yaml
code: awm

# Extension: src/modules/awm/extensions/security/module.yaml
code: awm  # SAME CODE — extends AWM
```

The **folder name** is unique (e.g., `awm-security`) but the `code:` matches the base module.
...
Affects the entire Arcwright framework and all modules.
...
**Example:** A module that provides universal logging or telemetry across Arcwright
...
- **kebab-case** (e.g., `awm`, `cis`, `bmgd`, `healthcare-ai`)
...
- **Core Arcwright** — Always available
