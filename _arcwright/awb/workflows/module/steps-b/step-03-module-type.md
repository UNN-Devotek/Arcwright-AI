...
"**Before we go further, we need to decide: What type of module is this?** This decision affects where files go, how installation works, and how the module integrates with Arcwright."
...
**Extension Module:**
- Extends an existing Arcwright module
- Shares the base module's code (e.g., `code: awm`)
- Adds or overrides agents/workflows
- Example: A security extension for AWM

**Global Module:**
- Affects the entire Arcwright framework
...
"Folder name will be unique: {e.g., awm-security}"
