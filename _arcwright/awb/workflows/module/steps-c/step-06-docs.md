...
buildTrackingFile: '{awb_creations_output_folder}/modules/module-build-{module_code}.md'
...
Created via Arcwright Module workflow

---

## License

Part of the Arcwright framework.
```
...
- [ ] {agent_name} ({agent_title})
  - Use: `arcwright:awb:agents:agent-builder`
...
{for each workflow}
- [ ] {workflow_name}
  - Use: `arcwright:awb:workflows:workflow` or `/workflow`
...
- [ ] Test installation with `arcwright install`
...
3. Consult the broader Arcwright documentation
```
...
- Review the main Arcwright documentation
...
**Select an Option:** [AR] Adversarial Review [C] Continue
