...
2. **Build agents** — Use `arcwright:awb:agents:agent-builder` for each agent spec
3. **Build workflows** — Use `arcwright:awb:workflows:workflow` for each workflow spec
4. **Test installation** — Run `arcwright install {module_code}`
...
"**🚀 You've built a module structure for Arcwright!**"
