...
agentValidationWorkflow: '{project-root}/_arcwright/awb/workflows/agent/steps-v/step-01-validate.md'
workflowValidationWorkflow: '{project-root}/_arcwright/awb/workflows/workflow/steps-v/step-01-validate.md'
---
...
- Use `arcwright:awb:agents:agent-builder` to create: {spec_agent_names}

**Spec Workflows:** {spec_count}
- Use `arcwright:awb:workflows:workflow` to create: {spec_workflow_names}
