...
editPlan: '{awb_creations_output_folder}/edit-plan-{agent-name}.md'
...
- Update all references to use `{project-root}/_arcwright/_memory/{sidecar-folder}/` format
...
- Ensure all references use correct `{project-root}/_arcwright/_memory/` paths
