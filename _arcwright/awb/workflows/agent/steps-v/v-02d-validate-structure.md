...
Validate the agent's YAML structure and completeness against Arcwright standards as defined in agentCompilation.md. Append findings to validation report and auto-advance.
...
- [ ] All critical_actions reference correct `{project-root}/_arcwright/_memory/` paths
