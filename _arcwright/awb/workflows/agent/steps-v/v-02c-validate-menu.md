...
Validate the agent's command menu structure against Arcwright standards as defined in agentMenuPatterns.md. Append findings to validation report and auto-advance.
...
7. **Configuration Specific Menu Handler Validation**
   ...
   - [ ] For hasSidecar: true:
     ...
     - [ ] Sidecar references use: `{project-root}/_arcwright/_memory/{sidecar-folder}/...`
