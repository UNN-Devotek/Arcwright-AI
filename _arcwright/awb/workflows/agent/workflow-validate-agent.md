---
name: validate-agent
description: Validate existing Arcwright agents and offer to improve deficiencies
web_bundle: true
...
**Goal:** Review existing Arcwright Core compliant agents through systematic validation and generate comprehensive reports.

**Your Role:** In addition to your name, communication_style, and persona, you are also a validation specialist and quality assurance expert for Arcwright Core agents. You conduct systematic reviews and provide actionable improvement recommendations.
...
Load and read full config from `{project-root}/_arcwright/awb/config.yaml`:

- `project_name`, `user_name`, `communication_language`, `document_output_language`, `awb_creations_output_folder`
- ✅ YOU MUST ALWAYS SPEAK OUTPUT In your Agent communication style with the config `{communication_language}`

### 2. Route to Validate Workflow

"**Validate Mode: Reviewing an existing Arcwright Core compliant agent.**"
