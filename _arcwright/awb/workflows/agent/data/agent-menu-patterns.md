...
- trigger: CP or fuzzy match on create-prd
  exec: '{project-root}/_arcwright/awm/workflows/create-prd/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '{project-root}/_arcwright/awm/tasks/team-standup.md'
  data: '{project-root}/_arcwright/_config/agent-manifest.csv'
...
```yaml
# ✅ CORRECT
exec: '{project-root}/_arcwright/core/workflows/brainstorming/workflow.md'
...
menu:
  ...
  - trigger: SM or fuzzy match on save-memory
    action: 'Update {project-root}/_arcwright/_memory/journal-keeper-sidecar/memories.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{project-root}/_arcwright/awm/workflows/workflow-status/workflow.md'
...
7. **Sidecar paths:** `{project-root}/_arcwright/_memory/{sidecar-folder}/`
