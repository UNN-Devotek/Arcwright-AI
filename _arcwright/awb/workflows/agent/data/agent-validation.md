...
- [ ] `module`: `stand-alone`|`awm`|`cis`|`bmgd`|...
...
- [ ] No `{project-root}/_arcwright/_memory/` paths
...
- [ ] ALL sidecar paths: `{project-root}/_arcwright/_memory/{sidecar-folder}/...`
...
| `./sidecar/memories.md` | `{project-root}/_arcwright/_memory/sidecar/memories.md` |
