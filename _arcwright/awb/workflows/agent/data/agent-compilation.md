...
agent:
  ...
  critical_actions:              # Optional - ANY agent can have these
    - "Load COMPLETE file {project-root}/_arcwright/_memory/journal-sidecar/memories.md"
    - "Load COMPLETE file {project-root}/_arcwright/_memory/journal-sidecar/instructions.md"
    - "ONLY read/write files in {project-root}/_arcwright/_memory/journal-sidecar/"
