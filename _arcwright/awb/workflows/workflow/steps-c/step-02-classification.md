...
**Module-Based (AWB, AWM, CIS, BMGD, etc.):**
...
- **AWB** - Module building workflows
- **AWM** - Software development workflows (PRDs, architecture, etc.)
...
- Look for folder at `{awb_creationsOutputFolder}/workflows/{proposed-name}/`
...
- Typically: `_arcwright/custom/src/workflows/{workflow-name}/`
...
- IF A: Execute {project-root}/_arcwright/core/workflows/advanced-elicitation/workflow.xml
- IF P: Execute {project-root}/_arcwright/core/workflows/party-mode/workflow.md
