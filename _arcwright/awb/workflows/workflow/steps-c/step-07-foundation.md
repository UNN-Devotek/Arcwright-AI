...
targetWorkflowPath: '{awb_creations_output_folder}/workflows/{new_workflow_name}'
...
**For AWB module workflows:** The target will be `_arcwright/custom/src/workflows/{workflow_name}/`
...
Display: **Foundation Complete - Select an Option:** [A] Advanced Elicitation [P] Party Mode [AR] Adversarial Review [C] Continue to Step 01 Build
