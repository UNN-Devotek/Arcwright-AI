...
description: 'Convert existing workflow to Arcwright compliant format by reading all instructions and extracting plan'
...
Convert an existing workflow (any format) to Arcwright compliant format by fully reading and understanding every instruction, extracting the essence, and creating a plan document.
...
"I can help you convert an existing workflow to Arcwright compliant format.
...
{List what's missing for Arcwright compliance}
```
...
**Ready to proceed?** [AR] Adversarial Review [C] Continue to Classification"
