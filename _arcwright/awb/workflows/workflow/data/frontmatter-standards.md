...
| Variable | Example |
|----------|---------|
| `{project-root}` | `/Users/user/dev/Arcwright-METHOD` <!-- validate-file-refs:ignore --> |
| `{project_name}` | `my-project` |
| `{output_folder}` | `/Users/user/dev/Arcwright-METHOD/output` <!-- validate-file-refs:ignore --> |
| `{user_name}` | `Brian` |
...
**Example:**
```yaml
awb_creations_output_folder: '{project-root}/_arcwright/awb-creations'
```
...
| External References | `{project-root}/...` | `{project-root}/_arcwright/core/workflows/...` |
...
```yaml
---
targetWorkflowPath: '{awb_creations_output_folder}/workflows/{workflow_name}'
---
```
