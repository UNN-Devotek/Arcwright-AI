...
editPlan: '{awb_creations_output_folder}/edit-plan-{workflow_name}.md'
...
Load the target workflow, check if it follows Arcwright step-file architecture, check for existing validation report, and offer to run validation if needed.
...
**Determine if workflow is Arcwright-compliant:**
...
I found that this workflow does not follow Arcwright step-file architecture:
...
This workflow follows Arcwright step-file architecture:
- ✅ workflow.md found
