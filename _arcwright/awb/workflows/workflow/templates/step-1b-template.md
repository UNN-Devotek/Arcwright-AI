# Arcwright Workflow Step 1B Continuation Template
...
workflow\*path: '{project-root}/_arcwright/[module-path]/workflows/[workflow-name]'
...
Display: "**Resuming workflow - Select an Option:** [AR] Adversarial Review [C] Continue to [Next Step Name]"
...
- `[module-path]` - e.g., "awb/reference" or "custom"
