# Arcwright Workflow Step Template

This template provides the standard structure for all Arcwright workflow step files. Copy and modify this template for each new step you create.
...
workflow\*path: '{project-root}/_arcwright/[module]/reference/workflows/[workflow-name]' # the folder the workflow.md file is in
...
Display: "**Select an Option:** [A] [Custom Action 1] [B] [Custom Action 2] [AR] Adversarial Review [C] Continue"
