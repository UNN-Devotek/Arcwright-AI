...
- When 'A' selected: Execute {project-root}/_arcwright/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Execute {project-root}/_arcwright/core/workflows/party-mode
...
[AR] Adversarial Review [C] Continue - Save these rules and move to next category"
...
After completing all rule categories and user selects 'C' for the final category, load `{project-root}/_arcwright/awm/workflows/generate-project-context/steps/step-03-complete.md` to finalize the project context file.
