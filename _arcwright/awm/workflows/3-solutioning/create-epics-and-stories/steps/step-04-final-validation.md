...
# Path Definitions
workflow_path: '{project-root}/_arcwright/awm/workflows/3-solutioning/create-epics-and-stories'
...
Write the validated output to {outputFile}, update frontmatter, then immediately load and execute: `{project-root}/_arcwright/core/tasks/help.md`
