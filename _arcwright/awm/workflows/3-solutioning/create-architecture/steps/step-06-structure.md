...
**Menu handling:**
- **A:** Read fully and follow: `{project-root}/_arcwright/core/workflows/advanced-elicitation/workflow.xml`. Ask "Accept changes? (y/n)". If yes: update content. Return to this menu.
...
- **C:** Append content to `{planning_artifacts}/architecture.md`, update frontmatter `stepsCompleted: [1, 2, 3, 4, 5, 6]`, then load `{project-root}/_arcwright/awm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`.
