...
- **C:** Append content to `{planning_artifacts}/architecture.md`, update frontmatter `stepsCompleted: [1, 2]`, then load `{project-root}/_arcwright/awm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`.
