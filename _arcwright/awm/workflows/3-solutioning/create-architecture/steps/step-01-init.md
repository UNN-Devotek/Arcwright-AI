...
Look for `{planning_artifacts}/*architecture*.md`. If found with `stepsCompleted` in frontmatter, **immediately load and follow** `{project-root}/_arcwright/awm/workflows/3-solutioning/create-architecture/steps/step-01b-continue.md` — do not proceed with fresh initialization.
...
- **C:** After setup is confirmed, load `{project-root}/_arcwright/awm/workflows/3-solutioning/create-architecture/steps/step-02-context.md`
