...
# File References
nextStepFile: '{project-root}/_arcwright/awm/workflows/1-analysis/create-product-brief/steps/step-06-complete.md'
...
When 'C' is selected and MVP scope is finalized and saved to document with frontmatter updated, read fully and follow `{nextStepFile}` to complete the product brief workflow.
