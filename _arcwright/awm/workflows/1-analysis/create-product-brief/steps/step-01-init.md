...
# File References
nextStepFile: '{project-root}/_arcwright/awm/workflows/1-analysis/create-product-brief/steps/step-02-vision.md'
...
- **STOP immediately** and load `{project-root}/_arcwright/awm/workflows/1-analysis/create-product-brief/steps/step-01b-continue.md`
...
After setup completion and frontmatter properly updated, read fully and follow `{nextStepFile}` to begin product vision discovery.
