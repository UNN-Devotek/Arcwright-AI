...
- Load: `{project-root}/_arcwright/awm/workflows/1-analysis/research/market-steps/step-02-customer-behavior.md`

## NEXT STEP:

Immediately after displaying scope confirmation and writing to the output file, load `{project-root}/_arcwright/awm/workflows/1-analysis/research/market-steps/step-02-customer-behavior.md` to begin detailed market research with customer insights analysis.
