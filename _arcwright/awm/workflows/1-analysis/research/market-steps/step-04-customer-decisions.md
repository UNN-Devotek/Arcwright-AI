...
_Evolution Patterns: [How factors change over time]_
_Source: [URL]_
...
[AR] Adversarial Review [C] Continue - Save this to document and proceed to competitive analysis
...
- Load: `{project-root}/_arcwright/awm/workflows/1-analysis/research/market-steps/step-05-competitive-analysis.md`
...
After user selects 'C', load `{project-root}/_arcwright/awm/workflows/1-analysis/research/market-steps/step-05-competitive-analysis.md` to analyze competitive landscape, market positioning, and competitive strategies for {{research_topic}}.
