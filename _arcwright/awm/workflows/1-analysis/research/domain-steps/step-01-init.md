...
- Load: `{project-root}/_arcwright/awm/workflows/1-analysis/research/domain-steps/step-02-domain-analysis.md`
...
Immediately after displaying scope confirmation and writing to the output file, load `{project-root}/_arcwright/awm/workflows/1-analysis/research/domain-steps/step-02-domain-analysis.md` to begin industry analysis.
