...
- Load: `{project-root}/_arcwright/awm/workflows/1-analysis/research/technical-steps/step-02-technical-overview.md`
...
Immediately after displaying scope confirmation and writing to the output file, load `{project-root}/_arcwright/awm/workflows/1-analysis/research/technical-steps/step-02-technical-overview.md` to begin technology stack analysis.
