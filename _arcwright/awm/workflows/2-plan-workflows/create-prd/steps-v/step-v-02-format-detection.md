...
Detect if PRD follows Arcwright format and route appropriately — classify as Arcwright Standard / Arcwright Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for Arcwright PRD Core Sections

Check if the PRD contains the following Arcwright PRD core sections:
...
- Follows Arcwright PRD structure closely

**Arcwright Variant:**
- 3-4 core sections present
- Generally follows Arcwright patterns but may have structural differences
- Missing some sections but recognizable as Arcwright-style

**Non-Standard:**
- Fewer than 3 core sections present
- Does not follow Arcwright PRD structure
...
**Arcwright Core Sections Present:**
...
**Format Classification:** [Arcwright Standard / Arcwright Variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is Arcwright Standard or Arcwright Variant:**
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach Arcwright PRD parity
