...
description: 'Document Parity Check - Analyze non-standard PRD and identify gaps to achieve Arcwright PRD parity'
...
Analyze non-standard PRD and identify gaps to achieve Arcwright PRD parity, presenting user with options for how to proceed.
...
### 1. Analyze Each Arcwright PRD Section

For each of the 6 Arcwright PRD core sections, analyze:
...
**Overall Effort to Reach Arcwright Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core Arcwright PRD sections. The overall effort to reach Arcwright standard is: **{effort level}**
...
**[AR] Adversarial Review [C] Continue Validation** - Proceed with validation using current structure
...
ALWAYS halt and wait for user input. Only proceed based on user selection.
