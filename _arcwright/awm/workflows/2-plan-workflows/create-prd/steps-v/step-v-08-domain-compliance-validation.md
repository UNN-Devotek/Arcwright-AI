...
Validate domain-specific requirements are present for high-complexity domains (Healthcare, Fintech, GovTech, etc.), ensuring regulatory and compliance requirements are properly documented. This step runs autonomously — no user input needed.

### Step-Specific Rules

- Focus ONLY on domain-specific compliance requirements
- FORBIDDEN to validate other aspects in this step
- Conditional validation based on domain classification
