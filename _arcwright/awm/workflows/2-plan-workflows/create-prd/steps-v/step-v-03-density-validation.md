...
Validate PRD meets Arcwright information density standards by scanning for conversational filler, wordy phrases, and redundant expressions that violate conciseness principles. This step runs autonomously — no user input needed.
