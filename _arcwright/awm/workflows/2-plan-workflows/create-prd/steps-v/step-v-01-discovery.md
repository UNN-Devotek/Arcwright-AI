...
This file contains the Arcwright PRD philosophy, standards, and validation criteria that will guide all validation checks. Internalize this understanding - it defines what makes a great Arcwright PRD.
...
Display: **Select an Option:** [A] Advanced Elicitation [P] Party Mode [AR] Adversarial Review [C] Continue to Format Detection
