...
- This is the final step — halt and wait for user selection after presenting menu
...
- **IF X (Exit):**
  ...
  - PRD Validation complete. Read fully and follow: `{project-root}/_arcwright/core/tasks/help.md`
