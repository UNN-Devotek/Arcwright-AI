...
# File References
nextStepFile: '{project-root}/_arcwright/awm/workflows/2-plan-workflows/create-prd/steps-c/step-12-complete.md'
outputFile: '{planning_artifacts}/prd.md'
purposeFile: '{project-root}/_arcwright/awm/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
...
- Read `{purposeFile}` to understand what makes a great Arcwright PRD
