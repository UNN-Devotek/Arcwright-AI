...
- Focus ONLY on review and analysis — no editing yet
- FORBIDDEN to make changes to PRD in this step
- User must confirm the change plan before proceeding
...
2. Analyze against Arcwright standards (from prd-purpose.md)
...
**[AR] Adversarial Review** - Stress-test change plan
...
- IF AR: Execute `{project-root}/_arcwright/core/tasks/review-adversarial-general.xml` — pass current editPlan as content to review; display findings with recommendations; then redisplay this menu
