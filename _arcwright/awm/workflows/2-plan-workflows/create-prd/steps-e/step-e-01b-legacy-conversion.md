...
Analyze legacy PRD against Arcwright standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
**For each Arcwright PRD section, analyze:**
...
- Manually check PRD for each Arcwright section
...
**For each Arcwright core section:**
...
**[R] Restructure to Arcwright** - Full conversion to Arcwright format, then apply your edits
