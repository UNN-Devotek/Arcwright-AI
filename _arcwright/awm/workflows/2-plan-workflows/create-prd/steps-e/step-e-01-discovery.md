...
prdPurpose: '{project-root}/_arcwright/awm/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
...
This file defines what makes a great Arcwright PRD. Internalize this understanding — it will guide improvement recommendations.
...
- Convert to Arcwright format (if legacy PRD)
...
**Check for Arcwright PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **Arcwright Standard:** 5–6 core sections present
- **Arcwright Variant:** 3–4 core sections present, generally follows Arcwright patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow Arcwright structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is Arcwright Standard/Variant:**
...
This PRD does not follow Arcwright standard structure (only {count}/6 core sections present).
...
**[C] Convert to Arcwright Format** - Convert PRD to Arcwright standard structure, then apply your edits
...
- IF E (Edit As-Is): Display "Proceeding with edits..." then load next step (step-e-02-review.md)
