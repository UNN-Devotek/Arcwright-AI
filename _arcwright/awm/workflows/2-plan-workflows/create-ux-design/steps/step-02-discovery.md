...
**If AR:** Execute `{project-root}/_arcwright/core/tasks/review-adversarial-general.xml` — pass the current content as the content to review; display findings with recommendations; then redisplay this menu.

**If C:**
- Append the final content to `{planning_artifacts}/ux-design-specification.md`
- Update frontmatter: `stepsCompleted: [1, 2]`
- Load `{project-root}/_arcwright/awm/workflows/2-plan-workflows/create-ux-design/steps/step-03-core-experience.md`
