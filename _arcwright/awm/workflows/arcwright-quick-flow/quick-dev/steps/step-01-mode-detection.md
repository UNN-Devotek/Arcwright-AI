...
- **NEXT:** Read fully and follow: `{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-dev/steps/step-03-execute.md`
...
- IF E: Ask for any additional guidance, then **NEXT:** Read fully and follow: `{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
**[W] Seems bigger than quick-dev** - Recommend the Full Arcwright Flow PRD Process
**[E] Execute directly**
...
- IF E: Ask for guidance, then **NEXT:** Read fully and follow: `{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
- Mode A (tech-spec): "**NEXT:** read fully and follow: `{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-dev/steps/step-03-execute.md`"
- Mode B (direct, [E] selected): "**NEXT:** Read fully and follow: `{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-dev/steps/step-02-context-gathering.md`"
