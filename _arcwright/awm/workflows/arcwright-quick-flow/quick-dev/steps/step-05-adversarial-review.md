...
```xml
<invoke-task>Review {diff_output} using {project-root}/_arcwright/core/tasks/review-adversarial-general.xml</invoke-task>
```
...
With findings in hand, read fully and follow: `{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.
