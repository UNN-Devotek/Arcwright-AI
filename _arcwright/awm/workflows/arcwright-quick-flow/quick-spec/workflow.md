...
main_config: '{project-root}/_arcwright/awm/config.yaml'
...
quick_dev_workflow: '{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-dev/workflow.md'
---
...
Read fully and follow: `{project-root}/_arcwright/awm/workflows/arcwright-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.
