...
Display: "**Select:** [AR] Adversarial Review [C] Continue [E] Edit [Q] Questions [A] Advanced Elicitation [P] Party Mode"
...
1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using {project-root}/_arcwright/core/tasks/review-adversarial-general.xml</invoke-task>
