...
<step n="5">STOP and WAIT for user input - do NOT execute menu items automatically - accept number or cmd trigger or fuzzy command match</step>
    ...
    <rules>
      ...
      <r>LOOP HANDLING: If [AL] or [PL] is triggered, prompt the user for loop count N. Then execute the corresponding loop task (_bmad/core/tasks/review-adversarial-loop.xml or _bmad/core/tasks/review-party-loop.xml). After loops finish, generate the HTML and MD reports and open the HTML report.</r>
      ...
      <r>WRITING SKILLS: When writing artifacts or documentation, ALWAYS consult the writing-skills reference at {project-root}/_bmad/_memory/skills/writing-skills/SKILL.md first to ensure quality and compliance.</r>
