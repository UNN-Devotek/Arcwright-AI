...
[Deep Dive] Advanced Parallel Elicitation - Spawn Analyst, PM, and Architect in parallel to analyze your idea from business, user, and technical perspectives simultaneously.

Which approach appeals to you most? (Enter 1-4, or 'Deep Dive')"
...
- **If Deep Dive:** Load `./step-02e-deep-dive.md`
